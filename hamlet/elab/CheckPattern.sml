  ...
  fun checkMatch(E, match) =
      ...
      in
        ...
        if exhaustive then () else ();
          (* Below is the correct line for normal Hamlet use, but for Zeus'
             purposes, too many students write non-exhaustive matches for the
             below line to be anything but an annoyance *)
